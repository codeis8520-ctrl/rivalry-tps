              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="md:col-span-2 bg-gradient-to-t from-slate-900 to-emerald-950/20 border border-emerald-500/25 p-6 rounded-2xl flex flex-col justify-between space-y-4 hover:border-emerald-500/45 transition-all hover:translate-y-[-2px] relative overflow-hidden shadow-lg shadow-emerald-950/10">
